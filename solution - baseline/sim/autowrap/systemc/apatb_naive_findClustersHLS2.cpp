...
// wrapc file define:
#define AUTOTB_TVIN_grid "../tv/cdatafile/c.naive_findClustersHLS2.autotvin_grid.dat"
#define AUTOTB_TVOUT_grid "../tv/cdatafile/c.naive_findClustersHLS2.autotvout_grid.dat"
#define AUTOTB_TVIN_pointsGrid "../tv/cdatafile/c.naive_findClustersHLS2.autotvin_pointsGrid.dat"
#define AUTOTB_TVOUT_pointsGrid "../tv/cdatafile/c.naive_findClustersHLS2.autotvout_pointsGrid.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_pointsGrid "../tv/rtldatafile/rtl.naive_findClustersHLS2.autotvout_pointsGrid.dat"
...
extern "C"
void naive_findClustersHLS2_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_naive_findClustersHLS2_hw(void* __xlx_apatb_param_grid, void* __xlx_apatb_param_pointsGrid)
{
#ifdef USE_BINARY_TV_FILE
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port0 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_grid),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_grid),
#endif
#endif
  };
  port0.param = { __xlx_apatb_param_grid };
  port0.nbytes = { 144 };
  port0.offset = {  };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_pointsGrid),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_pointsGrid),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_pointsGrid),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_pointsGrid),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_pointsGrid),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_pointsGrid),
#endif
#endif
  };
  port1.param = { __xlx_apatb_param_pointsGrid };
  port1.nbytes = { 2304 };
  port1.offset = {  };
  port1.hasWrite = { true };
  ...
  try {
    ...
    naive_findClustersHLS2_hw_stub_wrapper(__xlx_apatb_param_grid, __xlx_apatb_param_pointsGrid);
