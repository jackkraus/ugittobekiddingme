...
using hls::sim::Byte;
struct __cosim_s1200__ { char data[1200]; };
extern "C" __cosim_s1200__ naive_findClustersHLS1(Byte<4>*, char);
extern "C" void  apatb_naive_findClustersHLS1_hw(__cosim_s1200__* ap_return, volatile void * __xlx_apatb_param_grid, char __xlx_apatb_param_debug) {
using hls::sim::createStream;
  // Collect __xlx_grid__tmp_vec
std::vector<Byte<4>> __xlx_grid__tmp_vec;
for (size_t i = 0; i < 100; ++i){
__xlx_grid__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_grid)[i]);
}
  int __xlx_size_param_grid = 100;
  int __xlx_offset_param_grid = 0;
  int __xlx_offset_byte_param_grid = 0*4;
  // DUT call
  *ap_return = naive_findClustersHLS1(__xlx_grid__tmp_vec.data(), __xlx_apatb_param_debug);
// print __xlx_apatb_param_grid
for (size_t i = 0; i < __xlx_size_param_grid; ++i) {
((Byte<4>*)__xlx_apatb_param_grid)[i] = __xlx_grid__tmp_vec[__xlx_offset_param_grid+i];
}
}
