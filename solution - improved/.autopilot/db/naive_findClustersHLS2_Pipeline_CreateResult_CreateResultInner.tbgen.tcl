set moduleName naive_findClustersHLS2_Pipeline_CreateResult_CreateResultInner
set isTopModule 0
...
set C_modelName {naive_findClustersHLS2_Pipeline_CreateResult_CreateResultInner}
set C_modelType { void 0 }
set C_modelArgList {
	{ grid int 1 regular {array 144 { 1 3 } 1 1 }  }
	{ pointsGrid int 96 regular {array 144 { 0 3 } 0 1 }  }
	{ clusterGrid1 int 16 regular {array 144 { 1 3 } 1 1 }  }
	{ clusterGrid2 int 16 regular {array 144 { 1 3 } 1 1 }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "grid", "interface" : "memory", "bitwidth" : 1, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "clusterGrid2", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ clusterGrid1_address0 sc_out sc_lv 8 signal 2 } 
	{ clusterGrid1_ce0 sc_out sc_logic 1 signal 2 } 
	{ clusterGrid1_q0 sc_in sc_lv 16 signal 2 } 
	{ clusterGrid2_address0 sc_out sc_lv 8 signal 3 } 
	{ clusterGrid2_ce0 sc_out sc_logic 1 signal 3 } 
	{ clusterGrid2_q0 sc_in sc_lv 16 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "clusterGrid2_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "clusterGrid2", "role": "address0" }} , 
 	{ "name": "clusterGrid2_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "clusterGrid2", "role": "ce0" }} , 
 	{ "name": "clusterGrid2_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "clusterGrid2", "role": "q0" }}  ]}
...
set Spec2ImplPortList { 
	...
	clusterGrid1 { ap_memory {  { clusterGrid1_address0 mem_address 1 8 }  { clusterGrid1_ce0 mem_ce 1 1 }  { clusterGrid1_q0 in_data 0 16 } } }
	clusterGrid2 { ap_memory {  { clusterGrid2_address0 mem_address 1 8 }  { clusterGrid2_ce0 mem_ce 1 1 }  { clusterGrid2_q0 in_data 0 16 } } }
}
