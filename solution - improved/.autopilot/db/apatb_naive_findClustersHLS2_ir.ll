...
entry:
  call fastcc void @"onebyonecpy_hls.p0a12a12struct.ap_int<1>.24"([12 x [12 x i1]]* align 512 %1, [12 x [12 x %"struct.ap_int<1>"]]* %0)
...
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a12a12struct.Point.10([12 x [12 x %struct.Point]]* %2, [12 x [12 x i96]]* align 512 %3)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @onebyonecpy_hls.p0a12a12struct.Point.10([12 x [12 x %struct.Point]]* noalias %dst, [12 x [12 x i96]]* noalias readonly align 512 %src) unnamed_addr #2 {
entry:
...
copy:                                             ; preds = %entry
  call void @arraycpy_hls.p0a12a12struct.Point.13([12 x [12 x %struct.Point]]* nonnull %dst, [12 x [12 x i96]]* nonnull %src, i64 12)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse
define void @arraycpy_hls.p0a12a12struct.Point.13([12 x [12 x %struct.Point]]* %dst, [12 x [12 x i96]]* readonly %src, i64 %num) local_unnamed_addr #3 {
entry:
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  ...
  call void @arraycpy_hls.p0a12struct.Point.16([12 x %struct.Point]* %dst.addr, [12 x i96]* %3, i64 12)
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx2, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, %num
  br i1 %exitcond, label %for.loop, label %copy.split
...
; Function Attrs: argmemonly noinline norecurse
define void @arraycpy_hls.p0a12struct.Point.16([12 x %struct.Point]* %dst, [12 x i96]* readonly %src, i64 %num) local_unnamed_addr #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0a12a12struct.ap_int<1>.24"([12 x [12 x i1]]* noalias align 512 %dst, [12 x [12 x %"struct.ap_int<1>"]]* noalias readonly %src) unnamed_addr #2 {
entry:
...
copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a12a12struct.ap_int<1>.27"([12 x [12 x i1]]* nonnull %dst, [12 x [12 x %"struct.ap_int<1>"]]* nonnull %src, i64 12)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse
define void @"arraycpy_hls.p0a12a12struct.ap_int<1>.27"([12 x [12 x i1]]* %dst, [12 x [12 x %"struct.ap_int<1>"]]* readonly %src, i64 %num) local_unnamed_addr #3 {
entry:
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  ...
  call void @"arraycpy_hls.p0a12struct.ap_int<1>.30"([12 x i1]* %3, [12 x %"struct.ap_int<1>"]* %src.addr, i64 12)
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx2, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, %num
  br i1 %exitcond, label %for.loop, label %copy.split
...
; Function Attrs: argmemonly noinline norecurse
define void @"arraycpy_hls.p0a12struct.ap_int<1>.30"([12 x i1]* %dst, [12 x %"struct.ap_int<1>"]* readonly %src, i64 %num) local_unnamed_addr #3 {
entry:
