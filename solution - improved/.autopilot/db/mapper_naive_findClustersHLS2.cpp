...
extern "C" void naive_findClustersHLS2(Byte<1>*, Byte<16>*);
extern "C" void apatb_naive_findClustersHLS2_hw(volatile void * __xlx_apatb_param_grid, volatile void * __xlx_apatb_param_pointsGrid) {
using hls::sim::createStream;
  // Collect __xlx_grid__tmp_vec
std::vector<Byte<1>> __xlx_grid__tmp_vec;
for (size_t i = 0; i < 144; ++i){
__xlx_grid__tmp_vec.push_back(((Byte<1>*)__xlx_apatb_param_grid)[i]);
}
  int __xlx_size_param_grid = 144;
  int __xlx_offset_param_grid = 0;
  int __xlx_offset_byte_param_grid = 0*1;
  // Collect __xlx_pointsGrid__tmp_vec
std::vector<Byte<16>> __xlx_pointsGrid__tmp_vec;
for (size_t i = 0; i < 144; ++i){
__xlx_pointsGrid__tmp_vec.push_back(((Byte<16>*)__xlx_apatb_param_pointsGrid)[i]);
}
  int __xlx_size_param_pointsGrid = 144;
  int __xlx_offset_param_pointsGrid = 0;
  int __xlx_offset_byte_param_pointsGrid = 0*16;
  // DUT call
  naive_findClustersHLS2(__xlx_grid__tmp_vec.data(), __xlx_pointsGrid__tmp_vec.data());
// print __xlx_apatb_param_grid
for (size_t i = 0; i < __xlx_size_param_grid; ++i) {
((Byte<1>*)__xlx_apatb_param_grid)[i] = __xlx_grid__tmp_vec[__xlx_offset_param_grid+i];
}
// print __xlx_apatb_param_pointsGrid
for (size_t i = 0; i < __xlx_size_param_pointsGrid; ++i) {
((Byte<16>*)__xlx_apatb_param_pointsGrid)[i] = __xlx_pointsGrid__tmp_vec[__xlx_offset_param_pointsGrid+i];
}
}
