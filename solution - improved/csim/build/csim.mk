...
HLS_SOURCES = ../../../../main.cpp ../../../../cluster.cpp ../../../../generate.cpp
...
-include $(ObjDir)/cluster.d

$(ObjDir)/generate.o: ../../../../generate.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../generate.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/generate.d
